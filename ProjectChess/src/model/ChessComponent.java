...
//    private static final Dimension CHESSGRID_SIZE = new Dimension(1080 / 4 * 3 / 8, 1080 / 4 * 3 / 8);
    ...
    protected ChessComponent(ChessboardPoint chessboardPoint, ChessColor chessColor, ClickController clickController, int size, int size1, Chessboard chessboard) {
        setLayout(null);
        enableEvents(AWTEvent.MOUSE_EVENT_MASK);
        setVisible(true);
        setSize(size1,size);
        setLocation(chessboardPoint.getY()*size1,chessboardPoint.getX()*size);
