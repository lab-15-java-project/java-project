...
public class ClickController extends JFrame {
    ...
    public void left(int a){
        if (a==0&&chessboard.getCurrentColor()==ChessColor.BLACK){
            ...
            chessboard.add(first=new EmptySlotComponent(first.getChessboardPoint(),chessboard.getClickController(),chessboard.getCHESS_SIZE(),chessboard.getCHESS_SIZE(),chessboard));
